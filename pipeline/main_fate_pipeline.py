...
def main(config="config.yaml", namespace="", num_host=3):
    ...
    homo_nn_0 = HomoNN(name="homo_nn_0", encode_label=True, max_iter=15, batch_size=100,
    ...
    predict_pipeline.add_component(pipeline, data=Data(predict_input={pipeline.dataio_0.input.data: reader_1.output.data}))
